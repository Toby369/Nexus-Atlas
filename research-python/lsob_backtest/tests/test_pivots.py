...
def test_pivot_high_confirmed_with_delay():
    ...
    # Vorher/dazwischen nichts Falsches gemeldet.
...
def test_no_pivot_on_monotonic_series():
    # Eine rein monoton steigende Reihe hat keine lokalen Extrema (ausser an
    # den Raendern, die aber wegen fehlendem vollem Fenster gar nicht erst
    # geprueft werden).
...
def test_tie_does_not_confirm_pivot():
    # Ein gleich hoher Nachbar verhindert die Bestaetigung (strikte
    # Ungleichheit auf beiden Seiten, Pine-Konvention).
