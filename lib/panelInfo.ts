...
export const kurznotizInfo = `So liest du das: Automatisch generierter Kurztext, der dieselbe market_states-Zeile wie „NEXUS Assessment“ oben zusammenfasst (Gesamtzustand, Confidence, Datenabdeckung, ggf. führendes Muster, Risk) – kein eigener, unabhängiger Rechenweg mehr (bis vor Kurzem generierte diese Kachel ihre eigene, ausschliesslich preisbasierte Bybit-Einschätzung, was zu widersprüchlichen Aussagen zwischen Kurznotiz und NEXUS Assessment führen konnte; seit der Zusammenführung gibt es nur noch eine Quelle). Für die volle Faktor-Aufschlüsselung siehe „NEXUS Assessment“ ganz oben im Dashboard.
