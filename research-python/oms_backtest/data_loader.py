"""OHLCV-Datenbeschaffung. Identisch zu lsob_backtest/data_loader.py, nur
auf die Timeframes 1m/5m angepasst (siehe README "Warum CSV statt Live-
ccxt-Fetch" -- gleiche Sandbox, gleiche Netzwerk-Policy).
"""
